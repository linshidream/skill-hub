...
class ImageRecord:
    def __init__(self, original: str, resolved: str, status: str, note: str):
...
def resolve_output_image(
    ...
    if is_url(src):
        return ImageRecord(src, src, "remote", "Remote image kept as-is.")
    ...
    return ImageRecord(src, resolved, "copied", "Local image copied to output.")
