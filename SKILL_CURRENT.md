...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dev-lifecycle` | `0.1.3` | `dev` | 可用 | Claude Code / Codex / Generic | 2026-06-12 21:30 +0800 | 2026-06-17 17:41 +0800 | 可中断恢复地编排业务闭环级步骤开发、实时 step 状态、构建失败回修、分支生命周期和 Jenkins 测试部署流程。 | `skills/dev/dev-lifecycle` |
...
| `git-flow` | `0.1.3` | `dev` | 可用 | Claude Code / Codex / Generic | 2026-06-12 20:00 +0800 | 2026-06-17 17:41 +0800 | 管理单 feature 分支创建、按业务 step 提交、推送和测试分支集成，支持冲突分类、GUI merge 提示和冲突标记检查。 | `skills/dev/git-flow` |
